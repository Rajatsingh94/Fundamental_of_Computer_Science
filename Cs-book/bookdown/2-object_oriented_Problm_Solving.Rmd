...
```{r PassClass, echo = FALSE, out.width = "70%", fig.align='center',fig.cap="Passenger Class"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/PassClass.png")
```
...
```{r PassengerClassInstances, echo = FALSE, out.width = "75%",fig.align='center',fig.cap="Passenger Class and its Instance"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/PassengerClassInstances.png")
```
...
```{r MPViewOfClass, echo = FALSE, warning = FALSE, results = 'asis'}
...
# column 1 vector
Perspective <- c("Conceptual", "Specification", "Implementation")

# column 2 vector
Focus <- c("Conceptual understanding of the domain in an implementation independent context. Classes are viewed as *domain concepts* and relationships between the concepts.", "Rigorously specifying class *interfaces* in an implementation-independent way.", "Implementation-oriented specification of a class targeting class implementors.")

# column 3 vector
Structure <- c("*Attributes* characterize domain concepts.", "*Attributes* characterize class state. Attributes have unique names and are associated with types, default values, a range of allowable values, edit and validate checks.", "*Fields* or *data members* characterize class state.")

# column 4 vector
Functionality <- c("Class functionality is specified in terms of *responsibilities* or services.", "Class functionality is specified in terms of *operations*. Only those operations meant for consumption by other classes are shown. Operations are specified with complete *signature*.", "*Methods* or *member functions* specify class functionality.")

# data frame
multiplePerspectives <- data.frame(Perspective, Focus, Structure, Functionality, stringsAsFactors = FALSE)
...
```{r Associations, echo = FALSE, out.width = "75%",fig.align='center',fig.cap="Cadinality and Optionality aspects of association"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/Associations.png")
```
...
```{r DependentAssoc, echo = FALSE, out.height="50%", out.width = "65%", fig.align='center',fig.cap="Dependency association between classes"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/DependentAssoc.png")
```
...
```{r ClassHierarchy, echo = FALSE, out.height="50%", out.width = "75%", fig.align='center',fig.cap="Two Class hierarchies"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/ClassHierarchy.png")
```
...
```{r Interface, echo = FALSE, out.width = "55%", fig.align='center',fig.cap="Composite security master interface"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/Interface.png")
```
...
```{r CreateAccountUC, echo = FALSE, out.width = "75%", fig.align='center',fig.cap="A use case diagram"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/CreateAccountUC.png")
```
...
```{r SequenceDiagram, echo = FALSE, out.height="60%", out.width = "75%", fig.align='center',fig.cap="A sequence diagram"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/SequenceDiagram.png")
```
...
```{r CollaborationDiagram, echo = FALSE, out.height="50%", out.width = "75%", fig.align='center',fig.cap="A collaboration diagram"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/CollaborationDiagram.png")
```
...
```{r StateChart, echo = FALSE, out.width = "65%", fig.align='center',fig.cap="Statechart diagram of train ticket vending machine"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/StateChart.png")
```
...
```{r ChapDepend, echo = FALSE, out.height="50%", out.width = "75%", fig.align='center',fig.cap="An activity diagram"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/ChapDepend.png")
```
...
```{r StartupWindow, echo = FALSE, out.height="55%", out.width = "75%", fig.align='center',fig.cap="Startup window of IM application"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/StartupWindow.png")
```

```{r LoginWindow, echo = FALSE, out.height="50%", out.width = "75%", fig.align='center',fig.cap="Login window of IM application"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/LoginWindow.png")
```
...
```{r AdminFunctionsMenu, echo = FALSE, out.height="55%", out.width = "65%", fig.align='center',fig.cap="Admin functions menu"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/AdminFunctionsMenu.png")
```

```{r InstrumentCreation, echo = FALSE, out.height="55%", out.width = "55%",fig.align='center',fig.cap="Creating a financial instrument"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/InstrumentCreation.png")
```
...
```{r IMCreation, echo = FALSE, out.height="55%", out.width = "55%",fig.align='center',fig.cap="Creating an investment manager"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/IMCreation.png")
```
...
```{r AccountCreationMenu, echo = FALSE, out.width = "55%",fig.align='center',fig.cap="Investment manager functions"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/AccountCreationMenu.png")
```

```{r ViewingClients, echo = FALSE, out.height="55%", out.width = "55%",fig.align='center',fig.cap="Viewing and updating clients"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/ViewingClients.png")
```

```{r ViewingTransactions, echo = FALSE, out.height="55%", out.width = "55%",fig.align='center',fig.cap="Viewing account transactions"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/ViewingTransactions.png")
```

```{r ViewingUGL, echo = FALSE, out.width = "55%",fig.align='center',fig.cap="Viewing unrealized gain/loss"}
knitr::include_graphics("./Images/IntroObjProbSolv/Illus/ViewingUGL.png")
```
...
```{r IOOMatch, echo = FALSE, warning = FALSE, results = 'asis'}
...
# column 1 vector
Terminology <- c("Class", "Object", "Modifier method","Query Method","Instance field","Utility method","Static field","Instance method","Superclass","Static method","Subclass","Encapsulation","Abstraction","Polymorphism")

# column 2 vector
Explanations <- c("Also Known as set method.","Helps implement get and set methods.","Runtime instance of a class.","Class-level field.","Objects of the same kind.Objects of the same kind.","Also known as a get method.","Field contained in each object instance.","Bundling of related data and code.","Derived class.","Method invocation requires an object instance.","Showing relevant details while hiding irrelevant details.","Ability of a single variable to reference a variety of different
objects.","Method invoked on class itself.","Parent class.")

# create data frame
IooMatch <- data.frame(Terminology, Explanations, stringsAsFactors = FALSE)

library(knitr)

 kable(IooMatch, caption = "Exercise to test OO terminology") %>%
...
```{r ClassRelMatch, echo = FALSE, warning = FALSE, results = 'asis'}
...
# column 1 vector
Terminology <- c("Specialization", "Aggregation", "Binary Association","Composition","Recursive association","Generalization","Single Inheritance","Multiple Inheritance","Part-of-relationship")

# column 2 vector
Explanations <- c("An association between two classes.","A superclass is less specific than a sub class.","A class can have only one immediate superclass.","Inverse of Has-A relationship.","A class can inherit from multiple immediate classes.","The contained class has no independence existence.","An association between instances of the same class.","A sub class is derived through this process.","The contained class has independent existence.")

# create data frame
ClassRelMatch <- data.frame(Terminology, Explanations, stringsAsFactors = FALSE)

library(knitr)

 kable( ClassRelMatch, caption = "Exercise to test class relationship terminology") %>%
   kable_styling(bootstrap_options = c("striped"))
...
```{r UMLMatch, echo = FALSE, warning = FALSE, results = 'asis'}
...
# column 1 vector
Terminology <- c("UML", "Use Case", "Actor","Class Diagram","Sequence diagram","Rational Unified Process","Collabration diagram","Object diagram","State diagram","Component diagram")

# column 2 vector
Explanations <- c("Represents a thing (living or otherwise) that interacts
with a system in a specific way.","An iterative software development process","A process independent language for visualizing;
specifying; constructing and documenting the artifacts
of a software-intensive system.","Shows a set of objects and their relationships at a
point in time. Also called instance diagrams.","State machine modeling the dynamic aspects of a
system.","Specifies what a system does without specifying
implementation details.","Used to model the static design view of a system.","Emphasizes the time-ordering of messages.","Illustrates the static implementation view of a system.","An interaction diagram that emphasizes the structural
organization of objects communicating via
messages.")

# create data frame
UMLMatch <- data.frame(Terminology, Explanations, stringsAsFactors = FALSE)

library(knitr)

 kable( UMLMatch, caption = "Exercise to UML terminology") %>%
   kable_styling(bootstrap_options = c("striped"))
